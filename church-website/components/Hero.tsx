      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            ...
            in Christ and serve our community with compassion.
          </motion.p>
          ...
          >
            <button className="group bg-white text-purple-900 px-8 py-4 rounded-full font-semibold hover:bg-purple-50 transition-all flex items-center gap-2 shadow-xl hover:shadow-2xl hover:scale-105">
              Plan Your Visit
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-purple-900 transition-all shadow-xl">
              Watch Live
            </button>
          </motion.div>
          ...
          >
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 text-white">
              ...
              <p className="text-white/80">Every Sunday at 9:00 AM</p>
            </div>
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 text-white">
